    ...
    <div className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-20 h-full flex flex-col justify-center items-center text-center px-4 sm:px-6 lg:px-8">
        <div className="animate-entrance max-w-4xl mx-auto">
          <span className="inline-block px-4 py-1.5 mb-4 text-xs font-medium uppercase tracking-wider bg-white/10 backdrop-blur-md rounded-full text-white border border-white/20">
          ...
          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 justify-center">
            <Link
              to="/events"
              className="px-8 py-4 rounded-full text-base font-medium bg-nepal-red text-white hover:bg-opacity-90 transition-all duration-300 transform hover:translate-y-[-2px] hover:shadow-lg"
            >
              Explore Events
            </Link>
            <Link
              to="/featured"
              className="px-8 py-4 rounded-full text-base font-medium bg-white/10 backdrop-blur-md border border-white/30 text-white hover:bg-white/20 transition-all duration-300 transform hover:translate-y-[-2px] flex items-center justify-center group"
            >
              Featured Events
